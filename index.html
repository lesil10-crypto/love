...
<body class="bg-slate-100 text-gray-800">
    ...
    <div id="auth-container" class="fixed inset-0 bg-slate-100 z-[100] flex items-center justify-center hidden">
        <div class="card p-8 text-center">
            ...
            <button id="google-login-btn" class="btn-3d !bg-blue-500 !text-white hover:!bg-blue-600 flex items-center justify-center w-full" onclick="signInWithGoogle()">
    ...
    <div id="app-container" style="visibility: hidden;">
        <div class="max-w-4xl mx-auto p-4 pb-24">
            ...
            <div id="search-bar-container" class="card p-6 mb-8 sticky top-4 z-10">
                <div class="flex flex-col sm:flex-row gap-4">
                    <input
                        type="text"
                        id="search-input"
                        placeholder="Google 로그인이 필요합니다..."
                        class="w-full px-4 py-3 text-lg border-2 border-slate-300 bg-slate-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition cursor-pointer disabled:cursor-not-allowed"
                        disabled 
                    >
                    <button id="search-button" class="btn-3d w-full sm:w-auto" onclick="checkSearchAccess()">
            ...
            <div id="shortcut-buttons" class="card p-4 grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
                ...
                <a href="https://gemini.google.com/" target="_blank" class="btn-3d flex flex-col items-center justify-center p-3 text-purple-600 !p-2 !text-sm">
                    <i data-lucide="sparkles" class="w-5 h-5 mb-1 text-purple-500" style="text-shadow: 1px 1px 1px #e0e5ec, -1px -1px 1px #c5c9d2;"></i>
                    Gemini
                </a>
            </div>
    ...
    <div id="search-choice-modal" class="modal-background hidden">
